...
- Merge pull request #116 from diggsweden/feat/reviewed-stadardised-error-handling
- Standardise problem detail responses
- Update java non-major (#115)

### Fixed

- Rename wallet runtime exception test
- Return 500 for wallet runtime exceptions
...
- Merge pull request #94 from diggsweden/renovate/major-java-major
- Update java major
- Merge pull request #95 from diggsweden/fix/address-opengrep-issues
